...
export interface IFunctionModuleResults<
  TCreated = FunctionModuleCreated,
  TSource = FunctionModuleSource,
  TMetadata = FunctionModuleMetadata,
  TCheck = FunctionModuleCheckResult,
  TActivation = FunctionModuleActivationResult,
  TValidation = FunctionModuleValidationResult,
  TDeletion = FunctionModuleDeletionResult,
  TUpdated = FunctionModuleUpdated,
  TTransport = FunctionModuleTransport,
> {
