/**
 * Unit test for View activation
 * Tests activateDDLS function
 *
 * Enable debug logs: DEBUG_TESTS=true npm test -- unit/view/activate.test
 */

import { AbapConnection, createAbapConnection, SapConfig } from '@mcp-abap-adt/connection';
import { setupTestEnvironment, cleanupTestEnvironment, getConfig } from '../../helpers/sessionConfig';
import { activateDDLS } from '../../../core/view/activation';
...
describe('View - Activate', () => {
  ...
  it('should activate view', async () => {
    ...
    const testCase = getEnabledTestCase('activate_view');
    if (!testCase) {
    ...
    try {
      validateTestCaseForUserSpace(testCase, 'activate_view');
    } catch (error: any) {
    ...
    const response = await activateDDLS(
      connection,
