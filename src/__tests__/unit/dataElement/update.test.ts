/**
 * Unit test for Data Element update
 * Tests updateDataElement function
 *
 * Enable debug logs: DEBUG_TESTS=true npm test -- unit/dataElement/update.test
 *
